...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-t border-t-black bg-gray-100 font-base [&>tr]:last:border-b-0',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-border text-text dark:border-darkBorder transition-colors bg-gray-100 font-base data-[state=selected]:bg-white',
      className,
    )}
    {...props}
  />
